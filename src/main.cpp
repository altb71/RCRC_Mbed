...
float Ts = 100.0e-6f;                         // 10 kHz, 20 kHz was not working with GPA + UART communication
...
int main()
{
    ...
    uart_comm_thread_send uart_com_send(&hardware, &uart_serial, .01f); // send communication thread
